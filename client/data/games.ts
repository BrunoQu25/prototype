...
export const games: Game[] = [
  {
    ...
    rating: 4.8,
    reviews: 156,
    description: "Un juego clásico de construcción y comercio donde los jugadores compiten por recursos en una isla. Perfecto para noches de estrategia familiar.",
    duration: "60-90 min",
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 203,
    description: "Conecta ciudades americanas construyendo rutas de ferrocarril. Un juego accesible pero estratégicamente profundo.",
    duration: "45-60 min",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 189,
    description: "Un emocionante juego cooperativo donde todos los jugadores trabajan juntos para evitar que enfermedades devasten el mundo.",
    duration: "45-60 min",
    players: "2-4 jugadores",
    difficulty: "Medio",
    price: 48,
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: 142,
    description: "Construye un paisaje medieval colocando fichas. Un juego elegante con reglas simples pero profundidad táctica.",
    duration: "30-45 min",
    players: "2-5 jugadores",
    difficulty: "Fácil",
    price: 35,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 167,
    description: "Un juego de colocación de fichas abstracto con una estética deslumbrante inspirada en azulejos portugueses.",
    duration: "30-45 min",
    players: "2-4 jugadores",
    difficulty: "Fácil",
    price: 38,
